        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                <h2 className="text-5xl md:text-6xl font-extrabold mb-8 leading-tight
                       text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-fuchsia-400">
                ...
                <div className="min-h-[50px] md:min-h-[60px] flex items-center justify-center mb-10">
                    <span className="text-fuchsia-400 font-bold text-3xl md:text-4xl"> {/* Changed to fuchsia-400 */}
                        <Typewriter
                            words={['Upload PDFs', 'Generate Quizzes', 'Master Concepts!']}
                            loop={0}
                            cursor
                            cursorStyle='|'
                            typeSpeed={70}
                ...
                <a
                    href="/login"
                    className="inline-flex items-center justify-center px-10 py-4 rounded-full text-lg font-semibold tracking-wide
                     bg-gradient-to-r from-purple-700 to-fuchsia-700 text-white shadow-xl // Stronger, deeper gradient
                     hover:from-purple-800 hover:to-fuchsia-800 // Darker on hover
