        ...
        <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg shadow-inner w-full max-w-lg mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-4 w-full">
                ...
                >
                    ...
                    />
                    {file ? (
                        <p className="text-purple-700 font-medium break-words">{file.name}</p>
                    ) : (
                        <p className="text-gray-500">
                            Drag & Drop your PDF here, or <span className="text-purple-600 font-medium">Browse</span>
                        </p>
                    )}
                    <p className="text-sm text-gray-400 mt-2">Max file size: 10MB (approx)</p>
                </label>
            ...
            {(extractedText || generatedMcqsCount > 0) && !error && (
                <div className="mt-6 w-full text-left bg-purple-50 p-4 rounded-lg border border-purple-200">
                    ...
                    {generatedMcqsCount > 0 && (
                        <p className="mt-4 text-green-700 font-semibold text-lg text-center">
                            🎉 {generatedMcqsCount} MCQs Generated Successfully! 🎉
                        </p>
                    )}
                </div>
            )}
