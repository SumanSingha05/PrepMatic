...
const AboutSection = () => {
    return (
        ...
        >
            {/* Background Ornaments / Subtle Glows for Depth - Adapted for About Section */}
            <div className="absolute inset-0 z-0 opacity-20"> {/* Slightly lower opacity for a calmer section */}
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center px-4">
                {/* Main Heading */}
                <h3 className="text-5xl md:text-6xl font-extrabold mb-12 leading-tight
                ...
                <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-16 opacity-90">
                    Our mission is to empower learners like you to master complex subjects **smarter, not harder**.
                    By putting you in control, our platform transforms your extensive notes into dynamic, AI-generated
                    **Multiple-Choice Questions** and **timed quizzes**. Spend less time on tedious preparation
                    and more on effective, focused practice.
                </p>

                {/* Feature/Value Proposition Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
                    {/* Card 1: Effortless Transformation */}
                    <div className="p-8 bg-gray-900/50 rounded-2xl shadow-2xl backdrop-blur-sm
                        ...
                        <p className="text-gray-400 text-lg">
                            Upload any PDF, and our advanced AI instantly converts your content into precise, ready-to-use MCQs.
                        </p>
                    </div>

                    {/* Card 2: AI-Powered Precision */}
                    <div className="p-8 bg-gray-900/50 rounded-2xl shadow-2xl backdrop-blur-sm
                        hover:scale-105 hover:shadow-blue-500/20 transition-all duration-300 transform border border-gray-800">
                        <div className="text-blue-400 mb-6">
                            <svg className="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-1.25-3M15 10V5a3 3 0 00-3-3m0 0l-1-1-1 1v3m0 0H9m1.5-4.5h.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h.375M12 10V5a3 3 0 00-3-3m0 0l-1-1-1 1v3m0 0H9m1.5-4.5h.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125h.375"></path>
                            </svg>
                        </div>
                        ...
                        <p className="text-gray-400 text-lg">
                            Our sophisticated algorithms ensure relevant, challenging questions derived directly from your material.
                        </p>
                    </div>

                    {/* Card 3: Optimized Learning */}
                    <div className="p-8 bg-gray-900/50 rounded-2xl shadow-2xl backdrop-blur-sm
                        ...
                        <p className="text-gray-400 text-lg">
                            Spend less time preparing questions and more time on focused practice to truly master your concepts.
                        </p>
                    </div>
                </div>
            </div>
