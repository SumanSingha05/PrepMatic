...
const Navbar = () => {
    return (
        <nav
            className="relative top-0 z-50 w-full flex justify-between items-center px-6 md:px-12 py-4 h-20
        ...
        >
            {/* Background Ornaments / Subtle Glows for Depth (Copied from Hero) */}
